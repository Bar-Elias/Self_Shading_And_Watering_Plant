...
void InitTIMER1(void)
{
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))->TCMPR = 46875;		 
...
int32_t main(void)
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	clr_all_panel(); 
	InitPWM(0);
	DrvADC_Open(ADC_SINGLE_END, ADC_SINGLE_CYCLE_OP, 0x03, INTERNAL_HCLK, 1); 
	...
	while (1)
	{
		...
		while (DrvADC_IsConversionDone() == 0)
			;								  
		LDR = ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[0].RSLT & 0xFFF;	  
		moisture = ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[1].RSLT & 0xFFF; 
